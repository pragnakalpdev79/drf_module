...
urlpatterns = [
    ...
    path('auth/user/delete/<str:uname>',DeleteUser.as_view(),name='delete_user'),
    path('auth/user/restore/<str:uname>',RestoreDeletedUserView.as_view(),name='restore_deleted'),
     #VIEWS FOR JWT
